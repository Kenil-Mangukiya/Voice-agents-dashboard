...
/* =========================================================
   LOS ANGELES COUNTY SERVICES LOADER
========================================================= */

async function loadLosAngelesCountyServices() {
  try {
    console.log("\n");
    console.log("═".repeat(66));
    console.log("📍 LOS ANGELES COUNTY - Services Loader");
    console.log("═".repeat(66));
    console.log();
    ...
    const jsonFilePath = path.join(
      __dirname,
      "../../db/phone_numbers_data/los-angeles-county-services.json"
    );
    ...
    console.log(`📄 Reading Los Angeles County services JSON...`);
    ...
    // Clear existing data for Los Angeles County
    console.log("🧹 Clearing existing LOS ANGELES services...");
    ...
    if (validServices.length > 0) {
      ...
      const byPriority = await Service.aggregate([
        { $match: { county: "LOS ANGELES", state: "CA" } },
      ...
      console.log(`Total LOS ANGELES services in database: ${finalCount}\n`);
      ...
      console.log("   • County: 'LOS ANGELES'");
    ...
    console.log("🎉 Los Angeles County services loaded successfully!\n");
    process.exit(0);
  } catch (error) {
    console.error("\n❌ Error loading Los Angeles County services:");
