...
/* =========================================================
   ORANGE COUNTY SERVICES LOADER
========================================================= */

async function loadOrangeCountyServices() {
  try {
    console.log("\n");
    console.log("═".repeat(66));
    console.log("📍 ORANGE COUNTY - Services Loader");
    console.log("═".repeat(66));
    console.log();
    ...
    const jsonFilePath = path.join(
      __dirname,
      "../../db/phone_numbers_data/orange-county-services.json"
    );
    ...
    console.log(`📄 Reading Orange County services JSON...`);
    ...
    // Clear existing data for Orange County
    console.log("🧹 Clearing existing ORANGE services...");
    ...
    if (validServices.length > 0) {
      ...
      console.log(`Total ORANGE services in database: ${finalCount}\n`);
    ...
    console.log("🎉 Orange County services loaded successfully!\n");
    process.exit(0);
  } catch (error) {
    console.error("\n❌ Error loading Orange County services:");
